...
import type { Branch, CustomCluster, CustomSkillItem } from '@/src/business-logic/types';
...
export function SkillBuilderClusterCard({ cluster, onRemove }: SkillBuilderClusterCardProps) {
